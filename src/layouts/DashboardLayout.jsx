...
import { Bell, CalendarRange, Car, ChartNoAxesCombined, ChevronDown, ChevronRight, CircleDollarSign, ClipboardList, CreditCard, Fuel, History, Landmark, LayoutDashboard, LogOut, Menu, Palette, Pencil, PhoneCall, ReceiptText, Search, Send, Settings, Store, UserCog, Users, UserRound, WalletCards, X } from 'lucide-react'
...
const navGroups = [
  ...
  { label: 'របាយការណ៍ប្រចាំថ្ងៃ', items: [{ key:'dailyReports',label:'របាយការណ៍ប្រចាំថ្ងៃ',icon:ClipboardList,permission:'daily_reports.view',children:[
    { to:'/daily-reports',label:'បញ្ជីរបាយការណ៍',icon:ClipboardList,permission:'daily_reports.view' },
    { to:'/daily-reports?status=submitted',label:'អនុម័តរបាយការណ៍',icon:Send,permission:'daily_reports.review' },
    { to:'/daily-reports/workspace',label:'Workspace បញ្ចូល',icon:Pencil,permission:'daily_reports.create' },
    { to:'/daily-reports/odometer',label:'កីឡូម៉ែត្រប្រចាំថ្ងៃ',icon:Car,permission:'daily_reports.view' },
  ]}] },
  ...
  ]}, { key:'debts',label:'គ្រប់គ្រងបំណុល',icon:CreditCard,permission:'dashboard.view',children:[
    { to:'/debts',label:'UX/UI បំណុល',icon:CreditCard,permission:'dashboard.view' },
    { to:'/debts/brand-system',label:'Brand System',icon:Palette,permission:'dashboard.view' },
  ]}]},
